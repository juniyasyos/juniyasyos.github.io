  ...
  var e = {
      ...
      9377: function (e, t, a) {
        ...
        var n = a(5471),
          ...
          d = {
            name: "App",
            components: {
              AppSidebar: () => a.e(639).then(a.bind(a, 7639)),
              Toolbar: () => a.e(85).then(a.bind(a, 7085)),
              Drawer: () => a.e(651).then(a.bind(a, 1651)),
              Views: () => a.e(903).then(a.bind(a, 903)),
              Footer: () => a.e(123).then(a.bind(a, 4504)),
            },
            data: () => ({
              isLoading: !0,
              refreshing: !1,
            ...
            methods: {
              ...
              getData() {
                (this.isLoading = !0),
                  s.A.getAllConfig().then((e) => {
                    e.success
                      ? (e.data.forEach((e) => {
                          "footer" == e.name
                            ? this.setFooterConfig(e.data.links)
                            : "general" == e.name
                            ? this.setGeneralConfig(e.data)
                            : "keysandsecurity" == e.name &&
                              this.setKeysAndSecutityConfig(e.data);
                        }),
                        (this.noData = !1),
                        (this.isLoading = !1))
                      : ((this.noData = !0), (this.isLoading = !1));
                  });
              },
            },
          },
          c = d,
          m = a(1656),
          l = (0, m.A)(c, i, o, !1, null, null, null),
          u = l.exports,
          p = a(3723);
        (0, p.k)("/service-worker.js", {
          ready() {
            console.log(
        ...
        const h = [
            {
              path: "/",
              name: "Home",
              component: () => a.e(962).then(a.bind(a, 2503)),
              meta: { title: "Home ", color: "#0277bd" },
            },
            {
              path: "/about",
              name: "About",
              component: () => a.e(594).then(a.bind(a, 2322)),
              meta: { title: "About ", color: "#0277bd" },
            },
            {
              path: "/team",
              name: "Team",
              component: () => a.e(632).then(a.bind(a, 4941)),
              meta: { title: "Team ", color: "#0277bd" },
            },
            {
              path: "/team/:id",
              name: "Team Details",
              component: () => a.e(89).then(a.bind(a, 7395)),
              meta: { title: "Team Details", color: "#0277bd" },
            },
            {
              path: "/events",
              name: "Events",
              component: () => a.e(268).then(a.bind(a, 1500)),
              meta: { title: "Events ", color: "#0277bd" },
            },
            {
              path: "/events/:id",
              name: "CustomEvent",
              component: () => a.e(198).then(a.bind(a, 2616)),
              children: [
                {
                  path: "/",
                  name: "CustomEventHome",
                  component: () => a.e(385).then(a.bind(a, 3194)),
                  meta: { isEvent: !0 },
                },
                {
                  path: "speakers",
                  name: "CustomEventSpeaker",
                  component: () => a.e(865).then(a.bind(a, 7898)),
                  meta: { isEvent: !0 },
                },
                {
                  path: "team",
                  name: "CustomEventTeam",
                  component: () => a.e(193).then(a.bind(a, 8081)),
                  meta: { isEvent: !0 },
                },
                {
                  path: "schedule",
                  name: "CustomEventSchedule",
                  component: () => a.e(877).then(a.bind(a, 6267)),
                  meta: { isEvent: !0 },
                },
                {
                  path: "partners",
                  name: "CustomEventPartners",
                  component: () => a.e(191).then(a.bind(a, 9213)),
                  meta: { isEvent: !0 },
                },
                {
                  path: "",
            ...
            },
            {
              path: "/speakers",
              name: "Speakers",
              component: () => a.e(593).then(a.bind(a, 9153)),
              meta: { title: "Speakers ", color: "#0277bd" },
            },
            {
              path: "/speakers/:id",
              name: "Speakers-Details",
              component: () => a.e(824).then(a.bind(a, 1303)),
              meta: { title: "Speakers ", color: "#0277bd" },
            },
            {
              path: "/volunteers",
              name: "Volunteers",
              component: () => a.e(771).then(a.bind(a, 6665)),
              meta: { title: "Volunteers ", color: "#0277bd" },
            },
            {
              path: "/partners",
              name: "Partners",
              component: () => a.e(866).then(a.bind(a, 1273)),
              meta: { title: "Partners ", color: "#0277bd" },
            },
            {
              path: "/contact",
              name: "Contact",
              component: () => a.e(353).then(a.bind(a, 9469)),
              meta: { title: "Contact ", color: "#0277bd" },
            },
            {
              path: "/blogs",
              name: "Blogs",
              component: () => a.e(386).then(a.bind(a, 5570)),
        ...
        var v = new r.Ay.Store({
            ...
            getters: { links: (e) => e.items },
            mutations: {
              setDrawer: (e, t) => (e.drawer = t),
              toggleDrawer: (e) => (e.drawer = !e.drawer),
              setEventDrawer: (e, t) => (e.eventDrawer = t),
              toggleEventDrawer: (e) => (e.eventDrawer = !e.eventDrawer),
              setGeneralConfig: (e, t) => (
                (e.config.generalConfig = t),
                localStorage.setItem("name", t.name)
              ),
              setKeysAndSecutityConfig: (e, t) =>
                (e.config.keysandsecurity = t),
              setFooterConfig: (e, t) => (e.config.footerConfig = t),
            },
            modules: {},
            actions: {},
          }),
        ...
        var A = new (y())({
            ...
            theme: {
              themes: {
                light: {
                  primary: w.A.blue,
                  secondary: w.A.grey.darken1,
                  accent: w.A.shades.black,
                  error: w.A.red.accent3,
                },
                dark: { primary: w.A.blue },
              },
            },
          }),
          j = {
            methods: {
              checkExistance: (e, t) => e && e.length > t,
              getCharString: (e) => {
                var t = e.split(" ");
                return t.length > 1
                  ? (
              ...
              getImgUrl(e, t = "noimage.jpg") {
                return e.length > 0 ? e : a(7461)("./" + t);
              },
              convtDate: (e) => {
                let t = new Date(e);
      ...
      8839: function (e, t, a) {
        ...
        var n = JSON.parse(
          ...
          c = {
            getTeam: () => n,
            getTeamMember: (e) => n.find((t) => t.id === e),
            getEvents: () => i ?? [],
            getEvent: (e) => i.find((t) => t.id === e),
            getCustomEvents: () => i.filter((e) => "custom" === e.type),
            getFeatureEvents: () => {
              const e = d.find((e) => "data" === e.id);
              return e ? e.eventid : [];
            },
            getSpeakers: () => o,
            getSpeaker: (e) => o.find((t) => t.id === e),
            getPartners: () => s,
            getPartner: (e) => s.find((t) => t.id === e),
            getConfig: () =>
              r.map((e) => ({ name: e.id, data: { ...e, id: void 0 } })),
          },
          m = a(6053);
        let l = {
          getTeam: () =>
          ...
          getEvent: (e) =>
            new Promise((t) => {
              const a = c.getEvent(e);
              t({ success: !!a, data: a || {} });
            }),
          getAllSpeakers: () =>
            new Promise((e) => {
              const t = c.getSpeakers();
              e({ success: !0, data: t });
            }),
          getSpeaker: (e) =>
            new Promise((t) => {
              const a = c.getSpeaker(e);
              t({ success: !!a, data: a || {} });
            }),
          getFeaturesEvents: () =>
            new Promise((e, t) => {
              try {
                const t = c.getFeatureEvents();
                t && 0 !== t.length
                  ? e({ success: !0, data: t })
                  : e({ success: !1, data: {} });
              } catch (a) {
          ...
          getAllPartners: () =>
            new Promise((e) => {
              const t = c.getPartners();
              e({ success: !0, data: t });
            }),
          getPartner: (e) =>
            new Promise((t) => {
              const a = c.getPartners(),
                n = a.find((t) => t.id === e);
              t({ success: !!n, data: n || {} });
            }),
          getAllConfig: () =>
      ...
      9270: function (e, t, a) {
        "use strict";
        e.exports = a.p + "img/about.b44a7c54.png";
      },
      7593: function (e, t, a) {
        "use strict";
        e.exports = a.p + "img/button.b07728a2.png";
      },
      1931: function (e, t, a) {
        "use strict";
        e.exports = a.p + "img/eventbanner.86af947b.jpg";
      },
      3456: function (e, t, a) {
        "use strict";
        e.exports = a.p + "img/eventcover.8ea1333d.png";
      },
      949: function (e, t, a) {
        "use strict";
        e.exports = a.p + "img/noimage.aa6a1acc.jpg";
      },
      1374: function (e) {
        "use strict";
        e.exports =
      ...
      6107: function (e, t, a) {
        "use strict";
        e.exports = a.p + "img/spakerhead.414c95cd.jpg";
      },
    },
    t = {};
  function a(n) {
    ...
    (function () {
      ...
      a.l = function (n, i, o, s) {
        if (e[n]) e[n].push(i);
          ...
          if (void 0 !== o)
            for (
              var c = document.getElementsByTagName("script"), m = 0;
              m < c.length;
              m++
            ) {
              var l = c[m];
        ...
        if (0 !== i)
          if (i) n.push(i[2]);
            ...
            var s = a.p + a.u(t),
              r = new Error(),
              d = function (n) {
                if (a.o(e, t) && ((i = e[t]), 0 !== i && (e[t] = void 0), i)) {
